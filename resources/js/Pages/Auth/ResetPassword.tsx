                    ...
                    <div className="bg-[#1a1a1f] border border-white/8 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden">
                        ...
                        <div className="px-8 py-8">
                            ...
                            <form onSubmit={submit} className="space-y-5">
                                <div>
                                    <label className="block text-sm font-medium text-gray-300 mb-1.5">Account email</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-500">
                                            <Mail size={16} />
                                        </div>
                                        <input
                                            ...
                                            className="block w-full pl-10 pr-4 py-3 text-sm border border-white/8 rounded-xl bg-white/3 text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#f79122] focus:border-transparent transition"
                                        />
                                    </div>
                                    {errors.email && (
                                        <p className="mt-1.5 flex items-center gap-1 text-xs text-red-400">
