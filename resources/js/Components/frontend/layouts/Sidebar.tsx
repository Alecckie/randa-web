    ...
    return [
        {
            group: 'Main',
            items: [
                { icon: <LayoutDashboard size={18} />, label: 'Dashboard',   key: 'dashboard', href: route('advert-dash.index'), badge: counts.unread_notifications },
                { icon: <Target size={18} />,          label: 'Campaigns',   key: 'campaigns', href: route('my-campaigns.index'), badge: counts.pending_payments },
